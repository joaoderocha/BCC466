...
float melhor_vizinho(int n, vector<int> &s, vector<vector<float>> &d, float fo,
...
float vizinho_first_improvement(int n, vector<int> &s, vector<vector<float>>&d,
                                float fo, int *melhor_i, int *melhor_j);

/* Método da descida com estrategia aleatoria */
float descida_randomica(int n, vector<int> &s, vector<vector<float>> &d,
                        int IterMax);

float vizinho_aleatorio(int n, vector<int> &s, vector<vector<float>>&d,
                        float fo, int *melhor_i, int *melhor_j);

//float melhor_vizinho_adjacente(int n, vector<int> *s, vector<vector<float>>& d, float fo, int *melhor_i, int *melhor_j);
